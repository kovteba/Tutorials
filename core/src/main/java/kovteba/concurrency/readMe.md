...
- [Как работает метод Thread.join()?](#Как-работает-метод-Thread.join()?)
- [Что такое dead lock?](#Что-такое-dead-lock?)
...
Это один из хороших вопросов с подвохом. Простыми словами, если исключение не поймано - нить мерта, если установлен 
