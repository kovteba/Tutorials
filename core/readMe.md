...
## Exception
[__Exception__](src/main/java/kovteba/exception) - это нештатная ситуация, ошибка во время выполнения программы. 
Самый простой пример - деление на ноль.   
...
+ [Top level class (Обычный класс).](src/main/java/kovteba/classtypes/topelevelclass)
...
[__Java Collection Framework__](src/main/java/kovteba/collectionframework) — иерархия интерфейсов и их реализаций, которая является частью `JDK` и позволяет 
